...
- #6329 `d0a10c1` acceptnonstdtxn option to skip (most) "non-standard transaction" checks, for tnet/regtest only (Luke-Jr)
...
- #7045 `72dccfc` Bugfix: Use unique autostart filenames on Linux for tnet/regtest (Luke-Jr)
...
- #7216 `9572e49` Removed offline tnet DNSSeed 'alexykot.me'. (tnull)
...
- #5987 `4899a04` Bugfix: Fix tnet-in-a-box use case (Luke-Jr)
