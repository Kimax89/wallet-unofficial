...
- #7480 `b49a623` Changed gebchcworkhps value to double to avoid overflow (instagibbs)
...
- #8049 `c028c7b` Expose information on whether transaction relay is enabled in `gebchcworkinfo` (laanwj)
