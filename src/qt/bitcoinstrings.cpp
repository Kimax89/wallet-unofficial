...
static const char UNUSED *bitcoin_strings[] = {
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Bitcoin Clashic"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "The %s developers"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      ""
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "%s is set very high!"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "(default: %s)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "(default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "<category> can be:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Block creation options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Cannot write default address"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Chain selection options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Change index out of range"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Connection options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Done loading"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Enable publish hash block in <address>"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Enable publish hash transaction in <address>"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Enable publish raw block in <address>"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Enable publish raw transaction in <address>"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Enable transaction replacement in the memory pool (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error initializing block database"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error loading %s"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error loading %s: You can't disable HD "
                                      "on a already existing HD wallet"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error loading block database"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error opening block database"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Importing..."),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Information"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Insufficient funds"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Invalid -proxy address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Invalid amount for -%s=<amount>: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Listen for JSON-RPC connections on "
                                      "<port> (default: %u or tnet: %u)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Listen for connections on <port> (default: %u or tnet: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Loading addresses..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Loading banlist..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Loading block index..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Loading wallet..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Location of the auth cookie (default: data dir)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Maintain at most <n> connections to peers (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Make the wallet broadcast transactions"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Node relay options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Print version and exit"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Reducing -maxconnections from %d to %d, "
                                      "because of system limitations."),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Rescanning..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Set key pool size to <n> (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Specify data directory"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Starting network threads..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "The source code is available from %s."),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "The transaction amount is too small to pay the fee"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "The wallet will avoid paying less than the minimum relay fee."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Transaction too large for fee policy"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "bitcoin-clashic",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Unable to bind to %s on this computer. "
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Use the test chain"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Verifying wallet..."),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Wallet options:"),
    QT_TRANSLATE_NOOP("bitcoin-clashic", "Warning"),
    QT_TRANSLATE_NOOP("bitcoin-clashic",
    ...
    QT_TRANSLATE_NOOP("bitcoin-clashic", "ZeroMQ notification options:"),
};
